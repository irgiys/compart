...
$query = "SELECT p.*, s.fullname, pi.quantity
        FROM product AS p 
        JOIN seller AS s ON (p.seller_id = s.id) 
        JOIN product_inventory AS pi ON (p.inventory_id = pi.id) 
        WHERE p.deleted_at IS NULL AND pi.quantity >= 1 ORDER BY p.discount DESC";
        ...
        <div class="container-fluid px-md-5 py-2">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link py-0 pe-4" href="checkout_status.php">
                        <div class="position-relative p-1">
