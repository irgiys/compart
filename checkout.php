        ...
        <div class="col">
            <form action="./functions/checkout.php" method="post" class="d-flex justify-content-center">
                <div class="d-flex flex-column justify-content-center vh-100 w-75 px-md-5">
                    ...
                    <input type="hidden" name="total" value="<?= $result["amount"] ?>">
                    ...
                    <div>
                        <a href="cart.php" class="btn btn-altsecondary text-white px-3 mt-3 fs-sm">
                            < </a>
                                <button type="submit" class="col btn btn-altprimary text-white px-5 mt-3 fs-sm">Pay</button>
                    </div>
                </div>
            </form>
        </div>
